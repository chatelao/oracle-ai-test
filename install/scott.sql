-- SCOTT/TIGER standard schema for Oracle
-- Adapted for Oracle Free / XE
...
DECLARE
    l_count NUMBER;
BEGIN
    SELECT count(*) INTO l_count FROM dba_users WHERE username = 'SCOTT';
    IF l_count > 0 THEN
...
-- Connect as SCOTT (or stay as SYSTEM and create tables in SCOTT schema)
-- To keep it simple and ensure it works with standard SQLcl connection,
-- we will use SCOTT schema prefix if we are still SYSTEM.
...
INSERT INTO SCOTT.EMP VALUES (7788,'SCOTT','ANALYST',7566,to_date('13-07-1987','dd-mm-yyyy')-85,3000,NULL,20);
...
INSERT INTO SCOTT.EMP VALUES (7876,'ADAMS','CLERK',7788,to_date('13-07-1987','dd-mm-yyyy')-8,1100,NULL,20);
